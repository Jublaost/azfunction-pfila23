    ...
    let config: AxiosRequestConfig = {
        ...
        data: {
            "message": {
                ...
                "body": {
                    "contentType": "html",
                    "content": "Hallo " + body.vorname + "<br /><br /><strong>Wir freuen uns sehr, dass du am diesjährigen Pfila dabei bist!</strong><br />Die detaillierten Informationen werden zu einem späteren Zeitpunkt zugestellt.<br />Bei allfälligen Fragen wende dich bitte an: ok@pfila23.ch<br /><br />Jublastische Grüsse<br />Das Pfila23 Team"
                },
                "toRecipients": [
                    {
                        "emailAddress": {

    ...
    let config: AxiosRequestConfig = {
        ...
        data: {
            "message": {
                ...
                "body": {
                    "contentType": "html",
                    "content": "Lieber " + body.vorname + "<br /><br /><strong>Vielen Dank fürs Anmelden als Helfende*r am Pfila 23.</strong><br />Wir werden uns bis Anfang April mit den definitiven Schichten bei dir melden. Falls du Fragen oder Anmerkungen hast oder sich etwas ändert, melde dich bei Lois: luisa.fornasiero@jublaost.ch.<br />Hier noch eine kleine Info zum Zeltplatz: Es gibt die Möglichkeit auf dem Pfilagelände zu übernachten. Dazu musst du aber dein eigenes Zelt mitnehmen. Da der Platz im Sittertobel leider etwas begrenzt ist, kannst du nur da schlafen, wenn du an zwei Tagen einen Einsatz hast. Für Verpflegung ist selbstverständlich gesorgt.<br />Bei allgemeinen Fragen wende dich bitte an: ok@pfila23.ch<br /><br />Wir freuen uns und liebe Grüsse<br /><br />Lois und Silja<br />Ressort Helfende"
                },
                "toRecipients": [
                    {
                        "emailAddress": {
